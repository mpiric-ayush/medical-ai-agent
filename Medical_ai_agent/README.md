...
1. **Parses** it via OCR/PDF extraction
2. **Embeds** it into Pinecone vector store
3. **Queries** the Neo4j medical knowledge graph (Hetionet + PubMed KG)
4. **Runs 4 specialized AI agents** in sequence
5. **Outputs** across 6 structured tabs:
   - 📋 Clinical Summary
...
1. Push code to GitHub (without `.env` — add to `.gitignore`)
